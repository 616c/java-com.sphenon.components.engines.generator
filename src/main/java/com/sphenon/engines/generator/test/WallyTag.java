...
public class WallyTag implements TagHandler {

    public WallyTag (CallContext context) {
    }
    ...
    public Vector<String> getHandledTags(CallContext context) {
        if (handled_tags == null) {
            handled_tags = new Vector<String>();
            handled_tags.add("wally");
        }
        return handled_tags;
    }
