...
public class TOMTemplateOverride extends Class_TOMNode {

    // Configuration ------------------------------------------------------------------

    // Construction -------------------------------------------------------------------

    public TOMTemplateOverride(CallContext context, TOMNode parent) throws InvalidTemplateSyntax {
        super(context, parent);
        TOMSkeleton skeleton = findSuperNode (context, TOMSkeleton.class, null);
        if (skeleton == null) {
            CustomaryContext.create((Context)context).throwConfigurationError(context, "Cannot find TOMSkeleton in TOM tree - polymorph cannot be applied");
            throw (ExceptionConfigurationError) null; // compiler insists
        }
        skeleton.setOverride(context, true);
    }
