...
public class Operation_JSPS2CUS implements Operation {

    public Operation_JSPS2CUS (CallContext context) {
    }
    ...
    public Execution execute (CallContext context, com.sphenon.basics.data.DataSink<Execution> execution_sink) {
        ...
        try {
            ...
            bw = new BufferedWriter(osw = new OutputStreamWriter(fos = new FileOutputStream(this.cus_file), "UTF-8"));

            Template t = new Class_Template(context, "dummy.path.DummyName", new File(this.jsps_file));

            TemplateParser tp = (TemplateParser) Factory_Aggregate.construct(context, "com/sphenon/engines/generator/parsers/Converter-JSPS-2-CUS", "Writer", bw);
